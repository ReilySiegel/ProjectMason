...
public class GreedyDFSManagerTests {
    @Test
    public void testFindPath() throws SQLException, ClassNotFoundException {

        MapDB mdb = new MapDB("testGreedyDFSFindPath");
        ...
        GreedyDFSManager asm = new GreedyDFSManager(mdb);
        ...
        System.out.println("If reach here, tests for GreedyDFSManager.getPath() are passed!");
    }
}
