...
public class DijkstraTests {
    ...
    public void DijkstraTest1()
    {
        ...
        DijkstraManager.assignNodeAdjacency(nodes, edges);

        Dijkstra a = new Dijkstra(nodes,"","");
        ...
        System.out.println("If reach here, tests for Dijkstra.adjacenciesToNodes() are passed!");
