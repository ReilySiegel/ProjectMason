...
public class DijkstraManagerTests {
    ...
    public void testFindPath() throws SQLException, ClassNotFoundException {
        ...
        DijkstraManager dsm = new DijkstraManager(mdb);
        LinkedList<AlgoNode> pathP10_P5 = dsm.getPath("oPARK01001","oPARK00501");
        ...
        System.out.println("If reach here, tests for DijkstraManager.getPath() are passed!");
    }
